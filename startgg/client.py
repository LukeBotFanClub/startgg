...
class StartGGClient(AsyncBaseClient):
    ...
    async def event_sets(self, event_id: int, page: int, per_page: int) -> EventSets:
        query = gql("""
    ...
    async def phase_sets(self, phase_id: int, page: int, per_page: int) -> PhaseSets:
        query = gql("""
    ...
    async def phase_group_sets(
        self, phase_group_id: int, page: int, per_page: int
    ) -> PhaseGroupSets:
        query = gql("""
    ...
    async def in_progress_set(self, set_id: int) -> InProgressSet:
        query = gql("""
    ...
    async def sets(self, player_id: int) -> Sets:
        query = gql("""
    ...
    async def set_entrants(self, set_id: int) -> SetEntrants:
        query = gql("""
    ...
    async def phase_groups_by_phase(
        self, phase_id: int, page: int, per_page: int
    ) -> PhaseGroupsByPhase:
        query = gql("""
    ...
    async def phase_seeds(self, phase_id: int, page: int, per_page: int) -> PhaseSeeds:
        query = gql("""
    ...
    async def attendee_count_events(
        self,
        tourney_slug: str,
        event_ids: Union[Optional[List[Optional[int]]], UnsetType] = UNSET,
    ) -> AttendeeCountEvents:
        query = gql("""
    ...
    async def tournaments_by_videogame(
        self, per_page: int, videogame_id: int
    ...
    async def tournaments_by_videogames(
        self,
        per_page: Union[Optional[int], UnsetType] = UNSET,
        videogame_ids: Union[Optional[List[Optional[int]]], UnsetType] = UNSET,
    ...
    async def tournaments_by_owner(
        self, per_page: int, owner_id: int
    ) -> TournamentsByOwner:
        query = gql("""
